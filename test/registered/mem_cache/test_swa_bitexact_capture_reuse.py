"""Component-level tests for riding a captured SWA window through prefix reuse.
...
Covers:
  ...
  * the window half of the strict reuse gate, including the host-gated clamp on
    a cross-request match and atomic Full+SWA leaf eviction.
"""
...
class TestSparseSwaReuseClamp(unittest.TestCase):
    """Under stride>1, non-stride pages have a Full-host copy
