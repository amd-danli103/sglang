...
// own: on ROCm there is no hardware instruction behind it, it is a hand-written bit
// twiddle, and a wrong rounding or saturation boundary in there does not show up as a
// failure in the fused kernels -- it just looks like fp8 quantizing worse than it should.
